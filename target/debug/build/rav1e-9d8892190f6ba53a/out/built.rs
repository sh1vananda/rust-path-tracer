...
#[doc=r#"The output of `C:\Users\cyber\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.89.0-nightly (bc8215286 2025-05-20)";
#[doc=r#"The output of `C:\Users\cyber\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\cyber\.rustup\toolchains\nightly-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.89.0-nightly (bc8215286 2025-05-20)";
